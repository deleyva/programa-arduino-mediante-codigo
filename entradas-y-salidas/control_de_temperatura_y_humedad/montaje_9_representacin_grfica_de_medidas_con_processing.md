...
[Aquí lo tienes](http://aularagon.catedu.es/materialesaularagon2013/Arduino-codigo/6_Control_robotica/MiProgramaProcesing.rar) \(rar - 1,96 KB\), sólo representa un valor, está puesto en el puerto 0 puertoArduino = new Serial\(this, Serial.list\(\)\[0\], 9600\);
...
Extraido de la página [http://diymakers.es/arduino-processing-primeros-pasos/](http://diymakers.es/arduino-processing-primeros-pasos/) pero adaptado, [te lo puedes descargar aquí ](http://aularagon.catedu.es/materialesaularagon2013/Arduino-codigo/6_Control_robotica/dymakers.rar) \(rar - 31,02 KB\)\(recuerda cambiar port = new Serial\(this, Serial.list\(\)\[0\], 9600\); por tu puerto \)
